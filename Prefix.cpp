...
{ // Output the prefix form of the infix expression e.
  // NextTokn is a member function in Expression class
  // to get the next token from e.And reverse also a
  // member function to reverse the order of e. It is assumed
  // that the last token in e is '#'. Also, '#' is used at
  // the bottom of the stack

    e.reverse(); // reverse the expression

    stack<char> s;      // initialize stack
    stack<char> output; // initialize stack
    s.push('#');
    output.push('#');
